...
void AliAnalysisTaskCMEv2A::UserCreateOutputObjects()
{
  ...
  for(int i=0; i<10; i++)
    {
      hp_QAMCQA_cent[i] = new TProfile(Form("hp_QAMCQA_cent_%d",i),Form("hp_QAMCQA_cent_%d",i),220,-1.1,1.1,tpmin,tpmax,"");
      h2_QAMCQA_cent[i] = new TH2F(Form("h2_QAMCQA_cent_%d",i),Form("h2_QAMCQA_cent_%d",i),220,-1.1,1.1,220,-1.1,1.1);
      ...
      // ---
      h_AT_X_deta_cent[i] = new TProfile(Form("h_AT_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_AT_X_detaP_cent[i] = new TProfile(Form("h_AT_X_detaP_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_AT_X_detaN_cent[i] = new TProfile(Form("h_AT_X_detaN_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      //h_diffq22_X_deta_cent[i] = new TProfile(Form("h_diffq22_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_diffq22_X_detaP_cent[i] = new TProfile(Form("h_diffq22_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_diffq22_X_detaN_cent[i] = new TProfile(Form("h_diffq22_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      //h_ATdiffq22_X_deta_cent[i] = new TProfile(Form("h_ATdiffq22_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_ATdiffq22_X_detaP_cent[i] = new TProfile(Form("h_ATdiffq22_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_ATdiffq22_X_detaN_cent[i] = new TProfile(Form("h_ATdiffq22_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");

      //h_diffq32_X_deta_cent[i] = new TProfile(Form("h_diffq32_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_diffq32_X_detaP_cent[i] = new TProfile(Form("h_diffq32_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_diffq32_X_detaN_cent[i] = new TProfile(Form("h_diffq32_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      //h_ATdiffq32_X_deta_cent[i] = new TProfile(Form("h_ATdiffq32_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_ATdiffq32_X_detaP_cent[i] = new TProfile(Form("h_ATdiffq32_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_ATdiffq32_X_detaN_cent[i] = new TProfile(Form("h_ATdiffq32_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");

      //h_diffq42_X_deta_cent[i] = new TProfile(Form("h_diffq42_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_diffq42_X_detaP_cent[i] = new TProfile(Form("h_diffq42_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_diffq42_X_detaN_cent[i] = new TProfile(Form("h_diffq42_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      //h_ATdiffq42_X_deta_cent[i] = new TProfile(Form("h_ATdiffq42_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_ATdiffq42_X_detaP_cent[i] = new TProfile(Form("h_ATdiffq42_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
      h_ATdiffq42_X_detaN_cent[i] = new TProfile(Form("h_ATdiffq42_X_deta_cent_%d",i),"",32,-1.6,1.6,tpmin,tpmax,"");
  ...
  for(int i=cbinlo; i<cbinhi; i++)
    {
      fOutputList->Add(hp_QAMCQA_cent[i]);
      fOutputList->Add(h2_QAMCQA_cent[i]);
      // --- second harmonic
  ...
  fOutputList->Add(h_Aq22_centPP);
  fOutputList->Add(h_Aq22_centNN);
...
void AliAnalysisTaskCMEv2A::UserExec(Option_t *) 
{
  ...
  if(isCentral||isSemiCentral||isMB)
    ...
    {
      if(debug>0) cout<<"doing MC, ignoring trigger"<<endl;
    }
  else
    {
  ...
  if(fMC) hp_QAMCQA_cent[icent]->Fill(MCqasymm,qasymm);
  if(fMC) h2_QAMCQA_cent[icent]->Fill(MCqasymm,qasymm);
      ...
      if(cent>=centlo&&cent<centhi)
	{
	  ...
	  if(donested)
	      ...
	      for(int i=0; i<d_ntrk; i++)
		{
		  ...
		  h_AT_X_deta_cent[icent]->Fill(DETA,charge3[i]);
		  if(pos) h_AT_X_detaP_cent[icent]->Fill(DETA,charge3[i]);
		  if(neg) h_AT_X_detaN_cent[icent]->Fill(DETA,charge3[i]);
		  if(pos) h_diffq22_X_detaP_cent[icent]->Fill(DETA,diffq22Pev);
		  if(neg) h_diffq22_X_detaN_cent[icent]->Fill(DETA,diffq22Nev);
		  if(pos) h_ATdiffq22_X_detaP_cent[icent]->Fill(DETA,diffq22Pev*charge3[i]);
		  if(neg) h_ATdiffq22_X_detaN_cent[icent]->Fill(DETA,diffq22Nev*charge3[i]);

		  if(pos) h_diffq32_X_detaP_cent[icent]->Fill(DETA,diffq32Pev);
		  if(neg) h_diffq32_X_detaN_cent[icent]->Fill(DETA,diffq32Nev);
		  if(pos) h_ATdiffq32_X_detaP_cent[icent]->Fill(DETA,diffq32Pev*charge3[i]);
		  if(neg) h_ATdiffq32_X_detaN_cent[icent]->Fill(DETA,diffq32Nev*charge3[i]);

		  if(pos) h_diffq42_X_detaP_cent[icent]->Fill(DETA,diffq42Pev);
		  if(neg) h_diffq42_X_detaN_cent[icent]->Fill(DETA,diffq42Nev);
		  if(pos) h_ATdiffq42_X_detaP_cent[icent]->Fill(DETA,diffq42Pev*charge3[i]);
		  if(neg) h_ATdiffq42_X_detaN_cent[icent]->Fill(DETA,diffq42Nev*charge3[i]);
