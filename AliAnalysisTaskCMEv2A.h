...
class AliAnalysisTaskCMEv2A : public AliAnalysisTaskSE
{
 ...
 private:
  ...
  TProfile *h_AT_X_deta_cent[10];//!
  TProfile *h_AT_X_detaP_cent[10];//!
  TProfile *h_AT_X_detaN_cent[10];//!
  TProfile *h_diffq22_X_deta_cent[10];//!
  TProfile *h_diffq22_X_detaP_cent[10];//!
  TProfile *h_diffq22_X_detaN_cent[10];//!
  TProfile *h_ATdiffq22_X_deta_cent[10];//!
  TProfile *h_ATdiffq22_X_detaP_cent[10];//!
  TProfile *h_ATdiffq22_X_detaN_cent[10];//!

  TProfile *h_diffq32_X_deta_cent[10];//!
  TProfile *h_diffq32_X_detaP_cent[10];//!
  TProfile *h_diffq32_X_detaN_cent[10];//!
  TProfile *h_ATdiffq32_X_deta_cent[10];//!
  TProfile *h_ATdiffq32_X_detaP_cent[10];//!
  TProfile *h_ATdiffq32_X_detaN_cent[10];//!

  TProfile *h_diffq42_X_deta_cent[10];//!
  TProfile *h_diffq42_X_detaP_cent[10];//!
  TProfile *h_diffq42_X_detaN_cent[10];//!
  TProfile *h_ATdiffq42_X_deta_cent[10];//!
  TProfile *h_ATdiffq42_X_detaP_cent[10];//!
  TProfile *h_ATdiffq42_X_detaN_cent[10];//!
  ...
  TProfile *hp_QAMCQA_cent[10];//!
  TH2F *h2_QAMCQA_cent[10];//!
